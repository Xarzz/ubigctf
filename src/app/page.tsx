  ...
  return (
    <div className="container mx-auto px-4 py-16 flex flex-col items-center justify-center min-h-[calc(100vh-8rem)] relative overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-center text-center mt-8 z-10 w-full max-w-4xl mx-auto">
        <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl font-mono text-white drop-shadow-[0_2px_10px_rgba(239,68,68,0.5)] mb-6 text-center leading-tight">
          Welcome to <span className="text-primary tracking-widest uppercase shadow-red-500 animate-typing">UbigCTF</span>
        </h1>
